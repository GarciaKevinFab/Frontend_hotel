...
export default function InvoiceFormPro() {
    const calcCompact = () =>
        window.innerHeight < 820 || window.innerWidth < 1280;
    ...
    const headWatch = useWatch({
        control,
        name: ["tipoDocumento", "serie", "numero"],
    });
        ...
        const onKey = (e) => {
            if ((e.metaKey || e.ctrlKey) && e.key.toLowerCase() === "b") {
                ...
                setToast({
                    type: "info",
                    title: "Tipo cambiado",
                    description: `Ahora: ${next === "01" ? "Factura (01)" : "Boleta (03)"
                        }`,
                });
            }
        };
    ...
    const onSubmit = useCallback(async (form) => {
        try {
            ...
            setToast({
                ...
                description: `ID Local: ${resp.data.idLocal}`,
            });
            setLastDoc({
                empresa_Ruc: EMISOR_RUC,
                tipo_Doc: payload.tipoDocumento,
                serie: payload.serie,
                correlativo: payload.numero,
            });
        } catch (err) {
    ...
    // Ctrl/Cmd+S = submit con deps correctas
    useEffect(() => {
        const h = (e) => {
    ...
    async function descargar(kind) {
        try {
            ...
            if (!doc) {
                ...
                if (!tipoDocumento || !serie || !numero) {
                    setToast({
                        ...
                        description: "Completa tipo, serie y número o emite primero.",
                    });
                    return;
                }
                doc = {
            ...
            const resp = await http.post(`/invoice/${kind}`, doc, {
                responseType: "blob",
            });
            let ext = "bin",
            ...
            setToast({
                type: "success",
                title: "Archivo listo",
                description: `Descargado: ${link.download}`,
            });
        } catch (err) {
            const msg = renderError(err);
            setToast({
    ...
    const isReadyToDownload = Boolean(
        (headWatch?.[0] && headWatch?.[1] && headWatch?.[2]) || lastDoc
    );
    ...
    const validarCliente = async () => {
        try {
            ...
            if (tipo === "6") {
                ...
                setValue("customerName", razon, {
                    shouldDirty: true,
                    shouldValidate: true,
                });
                setValue("customerAddress", dir || "—", {
                    shouldDirty: true,
                    shouldValidate: true,
                });
            ...
            setToast({
                ...
                description: e.message || "No se pudo validar",
            });
        }
    };
        ...
        >
            <div className="inv-header">
                ...
                <div className="inv-actions inv-header-right">
                    ...
                    <button
                        type="button"
                        disabled={!isReadyToDownload || downloading === "pdf"}
                    ...
                    <button
                        type="button"
                        disabled={!isReadyToDownload || downloading === "xml"}
                    ...
                    <button
                        type="button"
                        disabled={!isReadyToDownload || downloading === "cdr"}
                        onClick={() => descargar("cdr")}
                        className="btn btn-soft"
                    >
                        {downloading === "cdr" ? "Descargando…" : "CDR"}
                    </button>
                </div>
            </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="inv-form">
                        ...
                        <div className="grid-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="F001"
                                    {...register("serie", {
                                        required: "Serie requerida",
                                        pattern: { value: /^[FB]\d{3}$/i, message: "Usa F### o B###" },
                                    })}
                                    onBlur={(e) =>
                                        setValue("serie", (e.target.value || "").toUpperCase())
                                    }
                                />
                                {errors?.serie && (
                                    <p className="error-msg">{errors.serie.message}</p>
                                )}
                            </div>
                            <div>
                        ...
                        <div className="grid-6">
                            ...
                            <div>
                                ...
                                >
                                    <input
                                        className="field"
                                        {...register("customerRuc", { required: true })}
                                    />
                                    <button
                                        type="button"
                    ...
                    <section className="card">
                        ...
                        <div className="items-table">
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className="col-afe">
                                                    ...
                                                    <select
                                                        className="field"
                                                        {...register(`items.${index}.tipAfeIgv`)}
                                                    >
                                                    ...
                                                    <div style={{ marginTop: 8 }}>
                                                        <span
                                                            className={`chip ${afe === "10" ? "igv" : "exo"
                                                                }`}
                                                        >
                                                            {afe === "10" ? "IGV 18%" : "Exonerado"}
                                                        </span>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="col-imp">
                                                    ...
                                                    <input
                                                        className="field right readonly num"
                                                        readOnly
                                                        value={money(importe)}
                                                    />
                                                </div>
                                                <div className="col-act">
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <path
                                                                fill="currentColor"
                                                                d="M9 3h6l1 2h5v2H3V5h5l1-2Zm1 7h2v8h-2v-8Zm4 0h2v8h-2v-8ZM8 10h2v8H8v-8Z"
                                                            />
                                                        </svg>
                                                    </button>
                                                </div>
                            ...
                            <div className="items-foot">
                                <div className="foot-left muted">
                                    Enter en “Precio c/IGV” agrega un ítem nuevo.
                                </div>
                                <div className="foot-right">
                                    <span className="muted">Ítems:</span>{" "}
                                    <strong className="num">{fields.length}</strong>
                                </div>
                            </div>
                        </div>

                        <div className="items-fab">
                            <button type="button" onClick={handleAddItem} className="fab">
                                +
                            </button>
                        </div>
                    </section>
                    ...
                    <div className="cta-bar">
                        <div className="cta-hint">
                            Revisa los datos antes de emitir. Se aplicará IGV del 18% para
                            afectación 10.
                        </div>
                        <button
                            type="submit"
                        ...
                        >
                            {sending ? "Emitiendo…" : "Crear / Enviar Factura"}
                        </button>
                    </div>
                </form>
                ...
                <aside className="inv-aside">
                    <div className="card">
                        ...
                        <dl className="summary">
                            <div className="row">
                                <dt>Gravadas</dt>
                                <dd className="num">{money(totals.gravadas)}</dd>
                            </div>
                            <div className="row">
                                <dt>Exoneradas</dt>
                                <dd className="num">{money(totals.exoneradas)}</dd>
                            </div>
                            <div className="row">
                                <dt>IGV (18%)</dt>
                                <dd className="num">{money(totals.igv)}</dd>
                            </div>
                            <div className="sep" />
                            <div className="row">
                                <dt>Valor Venta</dt>
                                <dd className="num">{money(totals.valorVenta)}</dd>
                            </div>
                            <div className="row">
                                <dt>Sub Total</dt>
                    ...
                    <div className="card small">
                        ...
                        <ul className="bullets">
                            <li>
                                Precio unitario incluye IGV cuando la afectación es gravada (10).
                            </li>
